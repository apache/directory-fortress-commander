...
import org.apache.directory.fortress.web.common.ModalWindow;
...
public class ObjectSearchModalPanel extends Panel
{
    ...
    private static final Logger LOG = LoggerFactory.getLogger( ObjectSearchModalPanel.class.getName() );
