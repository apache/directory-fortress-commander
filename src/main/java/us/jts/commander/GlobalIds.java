...
public class GlobalIds
{
    ...
    public static final String ADMIN_MGR = "us.jts.fortress.rbac.AdminMgrImpl";
    public static final String REVIEW_MGR = "us.jts.fortress.rbac.ReviewMgrImpl";
    public static final String DEL_ADMIN_MGR = "us.jts.fortress.rbac.DelAdminMgrImpl";
    public static final String DEL_REVIEW_MGR = "us.jts.fortress.rbac.DelReviewMgrImpl";
    public static final String PWPOLICY_MGR = "us.jts.fortress.rbac.PwPolicyMgrImpl";
    public static final String AUDIT_MGR = "us.jts.fortress.rbac.AuditMgrImpl";
